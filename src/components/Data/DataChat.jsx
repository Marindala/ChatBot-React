...
/* https://blog.back4app.com/es/como-construir-un-chatbot-en-react-js/ */ //documentation
      ...
      <ThemeProvider theme={theme}>
        <ChatBot
          steps={[
            {
              id: "1",
              message: "Hola!! Bienvenida/o a Jidú!, Cómo es tú nombre?",
              trigger: "2",
            ...
            {
              id: "3",
              avatar: "../../../public/Mi.png",
              message: ({ previousValue }) => `Hola ${previousValue}, un placer conocerte!`,
              trigger: "4",
